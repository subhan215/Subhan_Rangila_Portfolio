      ...
      <div className={`absolute inset-0 top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF]">Subhan Rangila</span> <WavingHand />
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm an <TypewriterText texts={typedItems} />
            <br />
            <b>Welcome to my portfolio, designed to reflect creativity, logic, and clean solutions.</b>
          </p>
        </div>
      </div>
